...
setShow(false);
 ...
 return ( 
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Footer>
        <Button variant="secondary" onClick={handleClose}><FormattedMessage id="button.close" /></Button>
        <Button variant="danger" onClick={handleDelete}><FormattedMessage id="button.removetask" /></Button>
        </Modal.Footer>
    </Modal>
    </div>
 )
